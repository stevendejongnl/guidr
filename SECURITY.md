...
- **Decision**: Document and monitor pending upstream fix
...
- **CVE-2026-23745** (tar file overwrite): Pending semantic-release upstream fix
...
- [ ] Check for new ecdsa vulnerability updates
