...
describe('SessionService', () => {
  ...
  describe('createSession', () => {
    it('should create a new session with generated ID', async () => {
      ...
      const session = await sessionService.createSession('guide-1')
    ...
    it('should throw error if guide not found', async () => {
      ...
      await expect(sessionService.createSession('guide-999')).rejects.toThrow(
  ...
  describe('getSessionById', () => {
    ...
    it('should return null if session not found', async () => {
      ...
      const result = await sessionService.getSessionById('session-999')
  ...
  describe('getSessionsByGuideId', () => {
    it('should return sessions for guide', async () => {
      ...
      const result = await sessionService.getSessionsByGuideId('guide-1')

      expect(result).toEqual(sessions)
      expect(mockSessionRepository.findByGuideId).toHaveBeenCalledWith('guide-1')
    })
  })
  ...
  describe('getSessionsByStatus', () => {
    it('should return sessions with specific status', async () => {
      ...
      const result = await sessionService.getSessionsByStatus(SessionStatus.InProgress)

      expect(result).toEqual(sessions)
      expect(mockSessionRepository.findByStatus).toHaveBeenCalledWith(SessionStatus.InProgress)
    })
  })
  ...
  describe('startSession', () => {
    ...
    it('should throw error if session not found', async () => {
      ...
      await expect(sessionService.startSession('session-999')).rejects.toThrow(
  ...
  describe('pauseSession', () => {
    ...
    it('should throw error if session not found', async () => {
      ...
      await expect(sessionService.pauseSession('session-999')).rejects.toThrow(
        'Session with id session-999 not found'
      )
    })
  })
  ...
  describe('resumeSession', () => {
    ...
    it('should throw error if session not found', async () => {
      ...
      await expect(sessionService.resumeSession('session-999')).rejects.toThrow(
        'Session with id session-999 not found'
      )
    })
  })
  ...
  describe('completeSession', () => {
    it('should complete a session and save', async () => {
      ...
      await sessionService.completeSession('session-1')
    ...
    it('should throw error if session not found', async () => {
      ...
      await expect(sessionService.completeSession('session-999')).rejects.toThrow(
        'Session with id session-999 not found'
      )
    })
  })
  ...
  describe('cancelSession', () => {
    it('should cancel a session and save', async () => {
      ...
      await sessionService.cancelSession('session-1')
    ...
    it('should throw error if session not found', async () => {
      ...
      await expect(sessionService.cancelSession('session-999')).rejects.toThrow(
        'Session with id session-999 not found'
      )
    })
  })
  ...
  describe('moveToStep', () => {
    it('should move session to step and save', async () => {
      ...
      await sessionService.moveToStep('session-1', 'step-1')
    ...
    it('should throw error if session not found', async () => {
      ...
      await expect(sessionService.moveToStep('session-999', 'step-1')).rejects.toThrow(
        'Session with id session-999 not found'
      )
    })
    ...
    it('should throw error if guide not found', async () => {
      ...
      await expect(sessionService.moveToStep('session-1', 'step-1')).rejects.toThrow(
